...
add_action( 'tgmpa_register', 'affiliate_newspaperly_register_required_plugins' );
 ...
 */
function affiliate_newspaperly_register_required_plugins() {
	/*
	...
	$plugins = array(
		...
		array(
			'name'      => 'SEO Optimized Tables (Schema Microdata)',
			'slug'      => 'superb-tables',
			'required'  => false,
		),
	 ...
	 */
	$config = array(
		'id'           => 'affiliate-newspaperly',                 // Unique ID for hashing notices for multiple instances of TGMPA.
